...
# 
###how to run: python main.py <stapm_data_file> <k> <p>
...
#
#Example command: python main.py network.txt hse2012_stapm.csv 2 0.25 
import os
import sys
...
def run(stapm_data_file,network_file,k,p):
    ...
    cmd='python generate_social_network.py '+stapm_data_file+' '+network_file+' '+str(k)+' '+str(p)
    os.system(cmd)
    #run ABM simulation
    #command: python SmokingModel.py props/model.yaml
    cmd='python SmokingModel.py props/model.yaml'
    os.system(cmd)

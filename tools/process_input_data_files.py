...
At the end of the script, call the relevant function and comment out the other function calls using '#').
...
#set directories of input data and output files
indir='/mnt/u/smoking_cessation/dynamic_exogenous_variables/'
outdir='./data/'
#specify the input and output
stpm_prob_file='./smoking_state_transition_probabilities_England2.xlsx'
death_prob_file='./death_probs_abm.csv'
attempt_exogenous_dynamics_file=indir+'table_attempts_dynamic_extended.csv'
attempt_exogenous_dynamics_file2=outdir+'table_attempts_dynamic_extended_integers.csv'
maintenance_exogenous_dynamics_file=indir+'table_maintenance_dynamic_extended.csv'

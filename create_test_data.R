...
#add define values "newquitter", "ongoingquitter1,...,11", for the state variable
exsmokers<-exsmokers %>% 
...
exsmokers<-exsmokers %>% mutate(cprob=NULL,cprob2=NULL,prob_ongoquitter=NULL)
...
write.csv(testdata,file="X:/Shared/code/ABM_software/abm-software-all-versions/data/testdata.csv",row.names=F)
